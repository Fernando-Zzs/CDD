...
public class GameSystem extends MonoBehavior {
    public static ArrayList<com.SCUT.ZZS_YJX_YMX.cdd.Prefabs.Card> cards = new ArrayList<>();
    private ArrayList<com.SCUT.ZZS_YJX_YMX.cdd.Components.Card> lastCards = new ArrayList<>();
    private ArrayList<com.SCUT.ZZS_YJX_YMX.cdd.Components.Card> cards_com = new ArrayList<>();
    ...
    public com.SCUT.ZZS_YJX_YMX.cdd.Components.Card deliverCard() {
        com.SCUT.ZZS_YJX_YMX.cdd.Components.Card card = null;
        if (cardAmount >= 0) {
    ...
    public com.SCUT.ZZS_YJX_YMX.cdd.Components.Card deliverCard(ArrayList<com.SCUT.ZZS_YJX_YMX.cdd.Prefabs.Card> cards) {
        com.SCUT.ZZS_YJX_YMX.cdd.Components.Card card = null;
        if (cardAmount >= 0) {
            card = (Card) cards.get(cardAmount).getComponent(Card.class);
            cardAmount--;
    ...
    public boolean judgeCards(ArrayList<com.SCUT.ZZS_YJX_YMX.cdd.Components.Card> cards) {
    ...
    public void showCards(ArrayList<com.SCUT.ZZS_YJX_YMX.cdd.Components.Card> cards) {
        if (cards.size() == 5) {
...
//        }
        ...
        ((TransformAnimation) win.addComponent(new TransformAnimation())).beginScale(Vector3.one, 20 * GameViewInfo.deltaTime);
    }
    ...
    public void newGame() {
        ...
        for (int figure = 0; figure <= 12; figure++) {
            for (int suit = 0; suit <= 3; suit++) {
                cards.add(new com.SCUT.ZZS_YJX_YMX.cdd.Prefabs.Card(suit, figure, new Transform(
    ...
    public ArrayList<com.SCUT.ZZS_YJX_YMX.cdd.Prefabs.Card> getCards() {
        return cards;
    }
}